...
class TestAuthAndRoleSecurity:
    ...
    def test_student_role_claim_assigned_on_creation(self, mock_auth, client):
        ...
        response = client.post("/api/admin/students", json={
        ...
        mock_auth.set_custom_user_claims.assert_called_once_with(
            "student-claim-uid", {"role": "student"}
        )
    ...
    def test_update_student_claims(self, mock_auth, client, mock_db):
        ...
        response = client.put("/api/admin/students/update-uid", json={
